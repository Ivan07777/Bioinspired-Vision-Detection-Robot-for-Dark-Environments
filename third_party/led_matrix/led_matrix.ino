...
unsigned char table[3][16] = {
 //{0x00,0x18,0x18,0x18,0x18,0x18,0x3C,0xFF,0xFF,0x3C,0x18,0x18,0x18,0x18,0x18,0x00}, //prey
 //{0x00,0x00,0x00,0x70,0x88,0x84,0x42,0x21,0x21,0x42,0x84,0x88,0x70,0x00,0x00,0x00}//, //mating
 {0x00,0x00,0x00,0x60,0x66,0x06,0x06,0x06,0x06,0x06,0x06,0x66,0x60,0x00,0x00,0x00} //neutral
...
void loop() 
{
    ...
    IIC_start();
    IIC_send(0x88);// set the brightness display (value between 0x88 and 0x8C)
    IIC_end(); 
